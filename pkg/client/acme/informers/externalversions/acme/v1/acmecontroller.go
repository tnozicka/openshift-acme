...
import (
	...
	versioned "github.com/tnozicka/openshift-acme/pkg/client/acme/clientset/versioned"
	internalinterfaces "github.com/tnozicka/openshift-acme/pkg/client/acme/informers/externalversions/internalinterfaces"
	v1 "github.com/tnozicka/openshift-acme/pkg/client/acme/listers/acme/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AcmeV1().ACMEControllers().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AcmeV1().ACMEControllers().Watch(context.TODO(), options)
			},
		},
		&acmev1.ACMEController{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *aCMEControllerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&acmev1.ACMEController{}, f.defaultInformer)
}
