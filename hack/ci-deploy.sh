...
CONTROLLER_IMAGE=${CONTROLLER_IMAGE:-registry.svc.ci.openshift.org/${OPENSHIFT_BUILD_NAMESPACE}/pipeline:openshift-acme-controller}
EXPOSER_IMAGE=${EXPOSER_IMAGE:-registry.svc.ci.openshift.org/${OPENSHIFT_BUILD_NAMESPACE}/pipeline:openshift-acme-exposer}
